        ...
        <div className="bg-gradient-to-r from-red-50 to-pink-50 dark:from-red-900/20 dark:to-pink-900/20 border-l-4 border-l-red-500 p-3 sm:p-4 rounded-xl">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h4 className="font-bold text-red-800 dark:text-red-300 text-sm">
              Erro ao carregar o histórico de despesas
            </h4>
          </div>
    ...
    return (
      <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-4 sm:p-6 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50">
        ...
        <div className="text-center py-6 sm:py-8">
          <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-slate-100 to-stone-100 dark:from-slate-900/50 dark:to-stone-900/50 rounded-2xl flex items-center justify-center mx-auto mb-4">
            <span className="text-2xl sm:text-3xl">📊</span>
          </div>
          <h4 className="text-base sm:text-lg font-bold text-gray-800 dark:text-gray-200 mb-2">
            Nenhum registro de despesas encontrado
          </h4>
          <p className="text-gray-600 dark:text-gray-400 max-w-md mx-auto text-sm">
            Comece a monitorar suas despesas para ver seu histórico de gastos e
            padrões aqui.
          </p>
        </div>
      </div>
